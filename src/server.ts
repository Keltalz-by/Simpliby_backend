...
import { BuyerRoute } from './api/buyer/buyer.route';
...
const buyerRoute = new BuyerRoute();

const app = new App([buyerRoute, storeRoute, authRoute, userRoute, categoryRoute, productRoute]);
